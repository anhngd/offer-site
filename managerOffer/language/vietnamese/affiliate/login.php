...
$_['text_description']              = '<p>%s chương trình đại lý hoàn toàn miễn phí và cho phép thành viên nhận hoa hồng khi đặt liên kết hoặc liên kết trang web quảng cáo sản phẩm của %s. Bất kì giao dịch mua sản phẩm phát sinh từ liên kết sẽ nhận được phần trăm hoa hồng. Tỉ lệ hoa hồng hiện tại là %s.</p><p>Vui lòng xem trang FAQ để xem chính sách đại lý &amp; điều khoản.</p>';
