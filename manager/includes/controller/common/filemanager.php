...
class ControllerCommonFileManager extends Controller {
	...
	public function search() {
		...
		if ($files) {
			...
			foreach ($files as $file) {
				...
				if (stristr(basename($file), $keyword)){
	...
	private function deleteImagesList($name){

		$this->deleteCacheImages($name, 100, 100);

		$this->deleteCacheImages($name, $this->config->get('config_image_thumb_width'), $this->config->get('config_image_thumb_height'));

		$this->deleteCacheImages($name, $this->config->get('config_image_popup_width'), $this->config->get('config_image_popup_height'));

		$this->deleteCacheImages($name, $this->config->get('config_image_product_width'), $this->config->get('config_image_product_height'));

		$this->deleteCacheImages($name, $this->config->get('config_image_category_width'), $this->config->get('config_image_category_height'));

		$this->deleteCacheImages($name, $this->config->get('config_image_manufacturer_width'), $this->config->get('config_image_manufacturer_height'));

		$this->deleteCacheImages($name, $this->config->get('config_image_additional_width'), $this->config->get('config_image_additional_height'));

		$this->deleteCacheImages($name, $this->config->get('config_image_related_width'), $this->config->get('config_image_related_height'));

		$this->deleteCacheImages($name, $this->config->get('config_image_compare_width'), $this->config->get('config_image_compare_height'));

		$this->deleteCacheImages($name, $this->config->get('config_image_wishlist_width'), $this->config->get('config_image_wishlist_height'));

		$this->deleteCacheImages($name, $this->config->get('config_image_cart_width'), $this->config->get('config_image_cart_height'));

	}

	private function deleteCacheImages($name, $width, $height){
		...
		if (isset($width) && isset($height)){
			...
			$img_file =  DIR_IMAGE . 'cache/data/' . utf8_substr($name, 0, strrpos($name, '.')) . '-' . $width . 'x' . $height . '.' . $extension;
