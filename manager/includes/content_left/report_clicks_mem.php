...
<table class="table table-bordered table-striped table-condensed">
	<thead>
		<tr>
			<td colspan="11"><center><h2>Statistics from the date <?php echo $from;?> to <?php echo $to;?></h2></center></td>
		</tr>
		<tr>
			<th>ID</th>
			<th>Date</th>
	...
	<div class="span12 center">
		...
		<ul>
			<?php
				...
				{
					echo "<li class='prev'>";
					echo "<a href='./index.php?report=clicks&page=0&from=$from&to=$to&network=$nwk&offerId=$offerId'>← Previous</a>";
					echo "</li>";
				}
				else
				{
				...
				for($i=1;$i<=$numRows;$i++)
				{
					...
					{
					echo "<li><a href='./index.php?report=clicks&page=".($i-1)."&from=$from&to=$to&network=$nwk&offerId=$offerId'>$i</a></li>";
					}
				}
				if($page>=$numRows-1)
				{
				...
				{
					echo "<li class='next'><a href='./index.php?report=clicks&page=".($numRows-1)."&from=$from&to=$to&network=$nwk&offerId=$offerId'>Next → </a></li>";
				}
			?>
