...
<div class="box-content">
	...
	<div id="reponse_post"></div>
		...
		<?php } ?>
	 <table id="list_networks"  class="table table-bordered table-hover">
	        <thead>
	          <tr>
	...
	<legend>GLOBAL POSTBACK URL</legend>
	<form class="form-horizontal">
	    <div class="box-body">
	   		<div class="form-group">
			  <label for="typeahead" class="col-sm-2 control-label">Hasoffers</label>
			  <div class="col-sm-10">
			  	<input type="hidden" name="id_app" value="">
			    <input type="text" class="form-control" style="margin:0px" value="<?php echo $yourdomain."/".$dir_member;?>/postbacks.php?userId={aff_sub}&offerId={offer_id}" />
			  </div>
			</div>
	    </div>
	</form>
