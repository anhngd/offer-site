...
var dataString = 'id='+ encodeURIComponent(ID) + '&keyword=' + encodeURIComponent(keyword) + '&meta_keyword=' + encodeURIComponent(meta_keyword) + '&meta_description=' + encodeURIComponent(meta_description) + '&tags=' + encodeURIComponent(tags) + '&lang=' + encodeURIComponent(lang);
