      ...
      <li class="dropdown user user-menu">
        ...
        <ul class="dropdown-menu">
          ...
          <li class="user-footer">
            <div class="pull-left">
              <a href="./index.php?settings" style="color:black"><i class="halflings-icon user"></i> Setting</a>
            </div>
            <div class="pull-right">
              <a href="logout.php" style="color:black"><i class="halflings-icon off"></i> Logout</a>
            </div>
          </li>
        </ul>
      </li>
