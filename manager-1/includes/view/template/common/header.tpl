    ...
    <ul class="left" style="display: none;">
      ...
      <!--   <li id="news"><a class="top">News</a>
        <ul>
          ...
          <li><a href="<?php echo $news_author; ?>"><?php echo $text_news_author; ?></a></li>
          <li><a href="<?php echo $news_download; ?>"><?php echo $text_news_download; ?></a></li>
